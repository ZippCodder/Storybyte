...
return (
<div title="main menu" className="main-menu">
<i tabIndex={0} aria-haspopup="menu" aria-label="menu" aria-hidden="false" aria-controls="main-dropdown" className="fas fa-bars" onClick={toggleMenu} onKeyDown={keyToggle}></i>
